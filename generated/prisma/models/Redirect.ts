...
export type RedirectWhereInput = {
  ...
  id?: Prisma.IntFilter<"Redirect"> | number
  ...
  note?: Prisma.StringNullableFilter<"Redirect"> | string | null
  createdAt?: Prisma.DateTimeFilter<"Redirect"> | Date | string
  updatedAt?: Prisma.DateTimeNullableFilter<"Redirect"> | Date | string | null
}
...
export type RedirectScalarWhereWithAggregatesInput = {
  ...
  id?: Prisma.IntWithAggregatesFilter<"Redirect"> | number
  ...
  note?: Prisma.StringNullableWithAggregatesFilter<"Redirect"> | string | null
  createdAt?: Prisma.DateTimeWithAggregatesFilter<"Redirect"> | Date | string
  updatedAt?: Prisma.DateTimeNullableWithAggregatesFilter<"Redirect"> | Date | string | null
}
...
export type RedirectOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "source" | "destination" | "statusCode" | "isActive" | "note" | "createdAt" | "updatedAt", ExtArgs["result"]["redirect"]>
...
export type $RedirectPayload<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  scalars: runtime.Types.Extensions.GetPayloadResult<{
    id: number
    /**
     * Откуда: путь от корня без строки запроса, в нижнем регистре,
     * без слэша на конце. Нормализация — в `redirect-utils.ts`.
     */
    source: string
    /**
     * Куда: путь от корня или абсолютный адрес.
     */
    destination: string
    /**
     * 301 — постоянный (передаёт вес), 302 — временный, 410 — «удалено».
     */
    statusCode: number
    /**
     * Выключенное правило остаётся в таблице как история решения.
     */
    isActive: boolean
    /**
     * Зачем сделан редирект: «дубль Чуфут-Кале», «слаг с &laquo;».
     */
    note: string | null
    createdAt: Date
    updatedAt: Date | null
...
export interface RedirectFieldRefs {
  readonly id: Prisma.FieldRef<"Redirect", 'Int'>
  ...
  readonly note: Prisma.FieldRef<"Redirect", 'String'>
